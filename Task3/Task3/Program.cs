class Task3
{
    ...
    static void Main(string[] args)
    {
        ...
        // Check if no positive numbers were entered
        if (amountOfInputNumbers == 0)
        {
            Console.WriteLine("No positive numbers were entered, cannot calculate the arithmetic average");
        }
        else
        {
        ...
        // A leap year must not be divisible by 100 but must be divisible by 4
        else if (year % 100 != 0 && year % 4 == 0)
        {
            Console.WriteLine($"The year {year} is a leap year");
        }

        // All other cases the year is not a leap 
        else
        {
